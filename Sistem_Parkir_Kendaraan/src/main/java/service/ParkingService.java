...
public class ParkingService {
    ...
    public void cariData(Scanner sc) {
        ...
        view.headerCari();
        while (true) {
            System.out.println("Masukkan ID tiket / Plat / Jenis (Mobil/Motor). (ENTER untuk batal): ");
            ...
            if (cari.matches("\\d+")) {
                ...
                for (Parkir parkir : dataParkir) {
                    if (parkir.getJenis().toLowerCase().contains(cari.toLowerCase())) {
                        hasil.add(parkir);
                    }
                }
            } else {
                for (Parkir parkir : dataParkir) {
                    if (parkir.getPlat().equalsIgnoreCase(cari)) {
                        hasil.add(parkir);
                    }
                }
                if (hasil.isEmpty()) {
                    for (Parkir parkir : dataParkir) {
                        if (parkir.getPlat().toLowerCase().contains(cari.toLowerCase())) {
                            hasil.add(parkir);
                        }
                    }
                }
